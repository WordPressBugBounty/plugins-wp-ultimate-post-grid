...
registerBlockType( 'wp-ultimate-post-grid/grid', {
    apiVersion: 3,
    title: __( 'Grid' ),
    description: __( 'Display a WP Ultimate Post Grid.' ),
    icon: 'grid-view',
    keywords: [ 'wpupg' ],
            ...
            <div { ...blockProps }>{
                ...
                <Fragment>
                    ...
                    <Disabled>
                        ...
                        <ServerSideRender
                            block="wp-ultimate-post-grid/grid"
                ...
                :
                <Fragment>
                    <h5>WP Ultimate Post Grid - { __( 'Grid' ) }</h5>
                    <Button
                        isPrimary
                        isLarge
                        onClick={ insertGridModal }>
    ...
    save: (props) => {
        ...
        if ( attributes.id ) {
            ...
            return `[wpupg-grid id="${ attributes.id }"${ dynamic ? ` ${dynamic}` : ''}]`;
        } else {
            return null;
        }
    },
